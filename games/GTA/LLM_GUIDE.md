...
This directory (`games/GTA`) is your isolated project workspace. The MIX Engine is currently running and watching this folder. Any changes you make here will be instantly reflected in the live engine.
...
1. Place them in the `games/GTA/assets/` folder.
